...
@onready var title_label: Label = $PanelContainer/VBoxContainer/NotificationType
@onready var message_label: Label = $PanelContainer/VBoxContainer/NotificationMessage
